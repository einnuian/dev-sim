...
export const LEVERS = [
  ...
  { id: 'lvr-audit', icon: 'shield', name: 'Security Audit', cost: 7500,
    apply: (s) => { s.economy.techDebt = Math.max(0, s.economy.techDebt - 25); s.economy.reputation += 4; },
    blurb: 'Tech debt -25, Rep +4.' },
  { id: 'lvr-marketing', icon: 'star', name: 'Marketing Push', cost: 3500,
